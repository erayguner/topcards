...
def delete_user_handler(request: Request):
    try:
        ...
        delete_user(user_email, service)
        ...
        return {"status": "error", "message": f"Failed to delete user. Error: {e}", "code": 400}
...
def delete_user(user_email, service):
